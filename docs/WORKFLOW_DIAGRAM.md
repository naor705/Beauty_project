...
flowchart TB
    subgraph L1[" 🟢 LAYER 1 — Automated (cron, daily) "]
        ...
        Res -->|fetch trends| TT[(TikTok)]
        Res -->|fetch reels| IG[(Instagram)]
        Res --> ResultsDB[(💾 research_results)]
    end
...
flowchart TB
    subgraph Apis["External APIs"]
        ...
        IGAPI["📷 Instagram Graph API<br/>(research — TODO)"]
        TTAPI["🎵 TikTok Research API<br/>(research — TODO)"]
    end
    ...
    subgraph Core["Beauty Researcher  •  Node.js + TypeScript + SQLite"]
        ...
        DB["💾 SQLite<br/>research_results · trend_reports<br/>generated_content · approval_requests<br/>scheduled_posts · post_logs"]
